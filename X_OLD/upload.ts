...
// export const dynamicParams = true; // true | false, if true, the route is a dynamic route
// export const apiRoute = true; // true | false, if true, the route is an API route
export const config = {
    api: {
