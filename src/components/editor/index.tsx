        ...
        <div>
            <CKEditor
                ...
                config={{
                    ...
                    fontSize: {
                        options: ['9', '10', '11', '12', '13', 'default', '18', '20', '22', '24', '30', '40', '45', '50'],
                    ...
                    toolbar: [
...

                        {
                            ...
                            title: 'Other',
                            label: 'Other Options',
                            items: ['findAndReplace', 'code', 'removeFormat', 'specialCharacters', 'htmlEmbed'],
                        },
                    ],

                    image: {
                        toolbar: ['imageTextAlternative', 'toggleImageCaption', 'imageStyle:alignLeft', 'imageStyle:alignCenter', 'imageStyle:alignRight', 'linkImage', 'ImageStyle', 'ImageResize'],
                    },
                }}
            ...
            <div className="word-count">
                ...
                <div className="word-count__characters">Characters: {text.characters}</div>
            </div>
        </div>
    ) : (
